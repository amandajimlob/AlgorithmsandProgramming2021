...
````{r}
folder1 <- paste(getwd(), "/Task1/Healthy", sep="")
folder2 <- paste(getwd(), "/Task1/Severe_kidney_disease", sep="")
...
```{r}
SBS2 <- readRDS(paste(getwd(), "/Task3/SBS2.RDS", sep=""))
SBS13 <- readRDS(paste(getwd(), "/Task3/SBS13.RDS", sep=""))
...
special_interval_names <- fread(paste(getwd(), "/Task3/interval_names.txt", sep=""))
genomic_intervals <- fread(paste(getwd(), "/Task3/intervals.txt", sep=""))
patients <- fread(paste(getwd(), "/Task3/patients.txt", sep=""))
...
```{r}
cancers <- fread(paste(getwd(), "/Task3/patientsCancerType.txt", sep=""))
...
```{r}
tail(main_table)
breast_cancer_patients <- unlist(cancer_type[cancer_type=="Breast-AdenoCA", .SD[,1]])
